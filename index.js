...
module.exports = function (source, inputSourceMap) {
    ...
    function createPostfix(exportVarTree, exportedVars, exportedCollapsedVars, config, provideMap) {
        ...
        if (config.es6mode && exportedVars.length) {
            postfix += 'exports.default=' + exportedVars.shift() + ';Object.defineProperty(exports, \'__esModule\', { value: true });';
        } else if (config.es6mode && exportedCollapsedVars.length) {
            postfix += 'exports.default=' + getCollapsedKey(exportedCollapsedVars[0], provideMap) + ';Object.defineProperty(exports, \'__esModule\', { value: true });';
        }
